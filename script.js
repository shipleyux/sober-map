 ...
 * @param {Array} markerData - Array of pub objects with lat, lon, and soberPoints
 */
...
// Creation steps:
// 1. Defined an array of pubs using JSON, including title, location (lat/long), soberPoints score, and area.
